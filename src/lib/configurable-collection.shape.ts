 ...
 * @template {AnyIterable<E>} [T=InferCollectionType<C>] The collection type inferred from the configuration, or defaults to `unknown` if not specified.
 * @template [E=AnyIterableElement<T>] The element type inferred from the configuration, or defaults to `unknown` if not specified.
