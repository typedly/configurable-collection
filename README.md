...
A **TypeScript** type definitions package for configurable collections with configuration support based on [`@typedly/collection`](https://github.com/typedly/collection).
